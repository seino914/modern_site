    ...
    <main className="min-h-screen pt-16">
      ...
      <section className="py-24 sm:py-32 px-6 sm:px-8 lg:px-12 bg-muted/30">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl sm:text-4xl font-bold text-center mb-16">Expertise</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
            <Card className="p-8 hover:shadow-lg transition-all duration-300 border-2">
              ...
              <div className="flex flex-wrap gap-2.5">
                ...
                <Badge variant="secondary" className="px-3 py-1 text-sm">Next.js</Badge>
                <Badge variant="secondary" className="px-3 py-1 text-sm">TypeScript</Badge>
                <Badge variant="secondary" className="px-3 py-1 text-sm">TailwindCSS</Badge>
              </div>
            </Card>
            ...
            <Card className="p-8 hover:shadow-lg transition-all duration-300 border-2">
              ...
              <div className="flex flex-wrap gap-2.5">
                <Badge variant="secondary" className="px-3 py-1 text-sm">Figma</Badge>
                <Badge variant="secondary" className="px-3 py-1 text-sm">Design Systems</Badge>
                <Badge variant="secondary" className="px-3 py-1 text-sm">Prototyping</Badge>
                <Badge variant="secondary" className="px-3 py-1 text-sm">User Research</Badge>
              </div>
            </Card>
            ...
            <Card className="p-8 hover:shadow-lg transition-all duration-300 border-2">
              ...
              <div className="flex flex-wrap gap-2.5">
                <Badge variant="secondary" className="px-3 py-1 text-sm">GraphQL</Badge>
                <Badge variant="secondary" className="px-3 py-1 text-sm">Framer Motion</Badge>
                <Badge variant="secondary" className="px-3 py-1 text-sm">Jest</Badge>
                <Badge variant="secondary" className="px-3 py-1 text-sm">CI/CD</Badge>
              </div>
            </Card>
          </div>
        </div>
